...
import eu.aylett.asmble.compile.jvm.msplit.SplitMethod
...
open class AsmToBinary(
    val splitMethod: eu.aylett.asmble.compile.jvm.msplit.SplitMethod? = eu.aylett.asmble.compile.jvm.msplit.SplitMethod(
        Opcodes.ASM6
    ),
